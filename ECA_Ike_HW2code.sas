/* Ike's Code Updated by Ellie */
libname ts '/opt/sas/home/eacasey/sasuser.viya/Time_Series_Fall1/Data';

/* import necessary csv file */
proc import datafile='/opt/sas/home/eacasey/sasuser.viya/Time_Series_Fall1/Data/Ozone_Raleigh2.csv'
	dbms=csv out=ts.ozone  replace;
run;
...
/* Running Multiplicative Winters on test data set */
/* Final MAPE is 12.82% */
/* This is the MAPE we're reporting in the document bc this is how we would*/
/*expect it to actually perform on real data */
proc esm data=ts.monthly_ozone print=all plot=all
